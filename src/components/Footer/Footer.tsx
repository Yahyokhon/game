...
export default function Footer() {
  return (
    <>
      <footer className="bg-gray-800 text-center border-t border-gray-700 text-white ml-64">
        <div className="w-full max-w-screen-xl mx-auto  py-[38px]  text-white">
          ...
          <span className="block text-sm text-gray-500 sm:text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-foreground/80">
              <Link
                to=""
                className="hover:underline font-medium  text-gray-100"
              >
